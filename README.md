 ...
 * Execution
 * Test Results
 * Dimension Tested (Tests Only 1 assurance dimension: (e.g. fairness, robustness, safety, security, or performance)) Records how that aspect of the system was evaluated. 
 * Test objective 
 * Rationale
 * Datasets
 * Environments
